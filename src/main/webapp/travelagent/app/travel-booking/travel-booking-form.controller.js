...
(function() {
    ...
    function TravelBookingFormController($scope, TravelBooking, Customer, messageBag, $http) {
        ...
        $http.get('../api/travelagent/taxis')
        ...
        $http.get('../api/travelagent/hotels')
            .success(function(data) {
                $scope.hotels = data;
            })
            .error(function() {
        ...
        $http.get('../api/travelagent/flights')
            .success(function(data) {
                $scope.flights = data;
            })
            .error(function() {
        ...
        // Define a reset function, that clears the prototype new TravelBooking object, and
        ...
        $scope.reset = function() {
            ...
            // Clear input fields. If $scope.field was set to an empty object {},
